...
<div class="container mx-auto px-6 py-12">
    ...
    <section class="mb-16 text-center">
        <h1 class="text-4xl font-bold mb-6 text-white">Blindaje y Ciberseguridad</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
        ...
        <div class="bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-800 hover:shadow-md transition">
            <h3 class="text-xl font-bold text-white mb-2">Escudo Esencial</h3>
            <p class="text-sm text-slate-400 mb-6">Protección básica para evitar brechas comunes.</p>
            ...
            <a href="https://wa.me/573105341232?text=Hola,%20estoy%20interesado%20en%20el%20Plan%20Escudo%20Esencial"
               class="block text-center bg-slate-700 text-white py-3 rounded-lg font-semibold hover:bg-slate-600 transition">
                Seleccionar Plan
            </a>
        </div>
        ...
        <div class="bg-slate-900 p-8 rounded-2xl shadow-lg border-2 border-blue-500 relative">
            <span class="absolute top-0 right-8 bg-blue-500 text-white px-3 py-1 text-xs font-bold rounded-b-lg">RECOMENDADO</span>
            <h3 class="text-xl font-bold text-white mb-2">Defensa Proactiva</h3>
            <p class="text-sm text-slate-400 mb-6">Monitoreo constante y blindaje avanzado.</p>
            <ul class="text-sm text-slate-400 space-y-3 mb-8">
        ...
        {{-- Blindaje Total --}}
        <div class="bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-800 hover:shadow-md transition">
            <h3 class="text-xl font-bold text-white mb-2">Blindaje Total</h3>
            <p class="text-sm text-slate-400 mb-6">Solución integral para empresas de alto riesgo.</p>
            <ul class="text-sm text-slate-400 space-y-3 mb-8">
    ...
    <section class="bg-slate-800 p-8 rounded-2xl ">
        <h2 class="text-2xl font-bold mb-8 text-white">Otros Servicios de Seguridad</h2>
    ...
    <section class="mt-20">
        <h2 class="text-3xl font-bold text-center text-white mb-12">Protección integral para tu negocio</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="text-center p-6">
                <div class="text-4xl mb-4">🔒</div>
                <h3 class="font-bold text-white mb-2">Encriptación SSL</h3>
                <p class="text-sm text-slate-400">Conexiones seguras para tus usuarios</p>
            </div>
            <div class="text-center p-6">
                <div class="text-4xl mb-4">🛡️</div>
                <h3 class="font-bold text-white mb-2">Firewall Avanzado</h3>
                <p class="text-sm text-slate-400">Protección contra ataques DDoS y SQL Injection</p>
            </div>
            <div class="text-center p-6">
                <div class="text-4xl mb-4">🔄</div>
                <h3 class="font-bold text-white mb-2">Backup Automático</h3>
                <p class="text-sm text-slate-400">Copias de seguridad diarias de tu información</p>
            </div>
            <div class="text-center p-6">
                <div class="text-4xl mb-4">📋</div>
                <h3 class="font-bold text-white mb-2">Cumplimiento Legal</h3>
                <p class="text-sm text-slate-400">Ley 1581 de Habeas Data Colombia</p>
            </div>
        </div>
    </section>
