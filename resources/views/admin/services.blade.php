...
<div class="container mx-auto px-6 py-12">
    ...
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold text-white">Gestión de Servicios</h1>
    </div>
    ...
    <div class="bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-800 mb-12">
        <h2 class="text-xl font-bold mb-6 text-white">Agregar nuevo servicio</h2>
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="md:col-span-2">
                <textarea name="description" placeholder="Descripción (máx 1000 caracteres)"
                          ...
                          class="w-full px-4 py-3 rounded-lg border border-slate-700 bg-slate-800 text-white focus:border-blue-500 outline-none transition h-32
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-slate-300 mb-2">Imagen del servicio (opcional)</label>
        ...
        <table class="w-full text-left">
            <thead class="bg-slate-800 border-b border-slate-700">
                <tr>
                    ...
                    <th class="px-6 py-4 text-sm font-semibold text-slate-300">Categoría</th>
                    <th class="px-6 py-4 text-sm font-semibold text-slate-300">Imagen</th>
                ...
                @forelse($services as $service)
                    <tr class="border-b border-slate-700 hover:bg-slate-800 transition">
                        ...
                        <td class="px-6 py-4">
                            @php
                                $categoryColors = [
                                    'diseno' => 'bg-blue-900/30 text-blue-400',
                                    'ciberseguridad' => 'bg-slate-800 text-slate-300',
                                    'servicios_tecnicos' => 'bg-green-900/30 text-green-400'
                                ];
                                $categoryLabels = [
                                    'diseno' => 'Diseño Web',
                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                                <span class="text-slate-600 text-sm">Sin imagen</span>
                            @endif
                        </td>
                        <td class="px-6 py-4 text-sm text-slate-500">{{ $service->created_at->format('d/m/Y') }}</td>
