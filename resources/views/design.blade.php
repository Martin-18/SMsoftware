...
<div class="container mx-auto px-6 py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border-2 border-blue-500 relative">
            ...
            <a href="https://wa.me/573000000000?text=Hola,%20me%20interesa%20el%20Plan%20Intermedio%20de%20Diseño"
               class="block text-center bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition">
                Seleccionar Plan
            </a>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
            ...
            <a href="https://wa.me/573000000000?text=Hola,%20me%20interesa%20el%20Plan%20Premium%20de%20Diseño"
               class="block text-center bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition">
                Seleccionar Plan
            </a>
        </div>
    ...
    <section class="bg-slate-50 p-8 rounded-2xl">
        <h2 class="text-2xl font-bold mb-8 text-slate-900">Servicios Complementarios</h2>
