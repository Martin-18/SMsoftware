...
<div class="container mx-auto px-6 py-12">
    ...
    <section class="mb-16 text-center">
        <h1 class="text-4xl font-bold mb-6 text-slate-900 dark:text-white">Servicios Técnicos</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
        ...
        <div class="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-md transition">
            <div class="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center text-2xl mb-6">
                💻
            </div>
            <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">Instalación de Programas</h3>
            <p class="text-sm text-slate-500 dark:text-slate-400 mb-6">Instalación profesional de software y herramientas.</p>
        ...
        <div class="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-lg border-2 border-blue-600 dark:border-blue-500 relative">
            <span class="absolute top-0 right-8 bg-blue-600 dark:bg-blue-500 text-white px-3 py-1 text-xs font-bold rounded-b-lg">POPULAR</span>
            <div class="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center text-2xl mb-6">
                🔄
            </div>
            <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">Actualización de Software</h3>
            <p class="text-sm text-slate-500 dark:text-slate-400 mb-6">Mantén tu equipo al día con las últimas versiones.</p>
            <ul class="text-sm text-slate-600 dark:text-slate-400 space-y-3 mb-8">
        ...
        <div class="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-md transition">
            ...
            <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">Mantenimiento de Equipos</h3>
            <p class="text-sm text-slate-500 dark:text-slate-400 mb-6">Mantenimiento preventivo y correctivo de computadores.</p>
            <ul class="text-sm text-slate-600 dark:text-slate-400 space-y-3 mb-8">
    ...
    <section class="bg-slate-50 dark:bg-slate-800 p-8 rounded-2xl transition-colors duration-300">
        <h2 class="text-2xl font-bold mb-8 text-slate-900 dark:text-white">Otros Servicios Técnicos</h2>
