...
<div class="container mx-auto px-6 py-12">
    ...
    <section class="mb-16 text-center">
        <h1 class="text-4xl font-bold mb-6 text-white">Diseño Web Profesional</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
        {{-- Plan Básico --}}
        <div class="bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-800 ">
            <h3 class="text-xl font-bold text-white">PLAN BÁSICO – "Presencia Web"</h3>
            <p class="text-3xl font-black text-blue-600 my-4">$450.000 COP</p>
            <p class="text-sm text-slate-400 mb-6">Ideal para emprendedores y marcas personales.</p>
        ...
        {{-- Plan Intermedio --}}
        <div class="bg-slate-900 p-8 rounded-2xl shadow-sm border-2 border-blue-600 relative">
            <span class="absolute top-0 right-0 bg-blue-500 text-white px-3 py-1 text-xs font-bold rounded-bl-lg">POPULAR</span>
            <h3 class="text-xl font-bold text-white">PLAN INTERMEDIO – "Crecimiento Digital"</h3>
        ...
        {{-- Plan Premium --}}
        <div class="bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-800 ">
            <h3 class="text-xl font-bold text-white">PLAN PREMIUM – "Presencia Profesional"</h3>
    ...
    <section class="bg-slate-800 p-8 rounded-2xl ">
        <h2 class="text-2xl font-bold mb-8 text-white">Servicios Complementarios</h2>
    ...
    <section class="mt-20">
        <h2 class="text-3xl font-bold text-center text-white mb-12">¿Por qué elegir nuestro diseño web?</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="text-center p-6">
                <div class="text-4xl mb-4">📱</div>
                <h3 class="font-bold text-white mb-2">100% Responsive</h3>
                <p class="text-sm text-slate-400">Se adapta perfectamente a cualquier dispositivo</p>
            </div>
            <div class="text-center p-6">
                <div class="text-4xl mb-4">⚡</div>
                <h3 class="font-bold text-white mb-2">Ultra Rápido</h3>
                <p class="text-sm text-slate-400">Optimizado para cargar en segundos</p>
            </div>
            <div class="text-center p-6">
                <div class="text-4xl mb-4">🔍</div>
                <h3 class="font-bold text-white mb-2">SEO Optimizado</h3>
                <p class="text-sm text-slate-400">Preparado para posicionamiento en buscadores</p>
            </div>
            <div class="text-center p-6">
                <div class="text-4xl mb-4">🛠️</div>
                <h3 class="font-bold text-white mb-2">Fácil de Administrar</h3>
                <p class="text-sm text-slate-400">Panel intuitivo para gestionar tu contenido</p>
            </div>
        </div>
    </section>
