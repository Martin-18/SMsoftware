...
<div class="container mx-auto px-6 py-12">
    ...
    <section class="mb-16 text-center">
        <h1 class="text-4xl font-bold mb-6 text-slate-900">Diseño Web Profesional</h1>
        <p class="text-lg text-slate-600 max-w-2xl mx-auto">
            Impulsamos tu marca con sitios web administrables, optimizados y adaptables. Creamos experiencias digitales que conectan.
        </p>
    </section>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
            <h3 class="text-xl font-bold text-slate-900">PLAN BÁSICO – “Presencia Web”</h3>
            <p class="text-3xl font-black text-blue-600 my-4">$500.000 COP</p>
            <p class="text-sm text-slate-500 mb-6">Ideal para emprendedores y marcas personales.</p>
            ...
            <a href="https://wa.me/573000000000?text=Hola,%20me%20interesa%20el%20Plan%20Básico%20de%20Diseño" 
        ...
        <!-- Plan Intermedio -->
        <div class="bg-white p-8 rounded-2xl shadow-sm border-2 border-blue-500 relative">
            <span class="absolute top-0 right-0 bg-blue-500 text-white px-3 py-1 text-xs font-bold rounded-bl-lg">POPULAR</span>
            <h3 class="text-xl font-bold text-slate-900">PLAN INTERMEDIO – “Crecimiento Digital”</h3>
        ...
        <!-- Plan Premium -->
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
            <h3 class="text-xl font-bold text-slate-900">PLAN PREMIUM – “Presencia Profesional”</h3>
    ...
    <!-- Servicios Dinámicos del Admin -->
    <section class="bg-slate-50 p-8 rounded-2xl">
        <h2 class="text-2xl font-bold mb-8">Servicios Complementarios</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @foreach(\App\Models\Service::where('category', 'diseño')->get() as $service)
                <div class="p-6 bg-white rounded-lg shadow-sm border border-slate-100">
                    <h3 class="font-bold text-lg text-slate-900">{{ $service->title }}</h3>
                    <p class="text-slate-600 mt-2">{{ $service->description }}</p>
                </div>
            @endforeach
        </div>
    </section>
